    ...
    <div class="docs-table" id="agilex-table">
        ...
        <table>
            <tbody>
                        ...
                        <a href="https://docs.trossenrobotics.com/agilex_bunker_docs"
                           ...
                           target="_blank">
                            <img src="_static/_images/agilex_bunker.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX BUNKER documentation">
                        </a>
                    </td>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_bunker_pro_docs"
                           ...
                           target="_blank">
                            <img src="_static/_images/agilex_bunker_pro.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX BUNKER PRO documentation">
                        </a>
                    </td>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_bunker_mini_docs"
                           ...
                           target="_blank">
                            <img src="_static/_images/agilex_bunker_mini.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX BUNKER MINI documentation">
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_scout_mini_docs"
                           class="docs_link"
                           target="_blank">
                            <img src="_static/_images/agilex_scout_mini.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX SCOUT MINI documentation">
                        </a>
                    </td>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_scout_20_docs"
                           class="docs_link"
                           target="_blank">
                    ...
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_tracer_docs"
                           class="docs_link"
                           target="_blank">
                            <img src="_static/_images/agilex_tracer.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX TRACER documentation">
                        </a>
                    </td>
                </tr>
                <tr>
                    <td><p>AgileX Robotics SCOUT MINI</p></td>
                    <td><p>AgileX Robotics SCOUT 2.0</p></td>
                    <td><p>AgileX Robotics TRACER</p></td>
                </tr>
                <tr>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_hunter_20_docs"
                           class="docs_link"
                           target="_blank">
                            <img src="_static/_images/agilex_hunter_20.png"
                                 class="docs_link_img"
                                 alt="AgileX HUNTER 2.0">
                        </a>
                    </td>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_hunter_se_docs"
                           class="docs_link"
                           target="_blank">
                            <img src="_static/_images/agilex_hunter_se.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX HUNTER SE documentation">
                        </a>
                    </td>
                    <td>
                        <a href="https://docs.trossenrobotics.com/agilex_limo_docs"
                           class="docs_link"
                           target="_blank">
                            <img src="_static/_images/agilex_limo.png"
                                 class="docs_link_img"
                                 alt="Link to AgileX LIMO documentation">
                        </a>
                    </td>
                </tr>
                <tr>
                    <td><p>AgileX Robotics HUNTER 2.0</p></td>
                    <td><p>AgileX Robotics HUNTER SE</p></td>
                    <td><p>AgileX Robotics LIMO</p></td>
                </tr>
            </tbody>
        </table>
        <hr>
